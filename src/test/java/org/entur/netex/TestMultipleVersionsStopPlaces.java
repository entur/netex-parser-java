...
class TestMultipleVersionsStopPlaces {
  ...
  void testGetAllVersionsOfStopPlace() {
    Collection<StopPlace> stopPlaces = index
      .getStopPlaceIndex()
      .getAllVersions("NSR:StopPlace:5543");
    Assertions.assertEquals(8, stopPlaces.size());
  }

  @Test
  void testGetAllVersionsOfAllStopPlaces() {
    Map<String, Collection<StopPlace>> stopPlaces = index
      .getStopPlaceIndex()
      .getAllVersions();
  ...
  void testGetStopPlaceWithVersion() {
    StopPlace stopPlace = index
      .getStopPlaceIndex()
      .getVersion("NSR:StopPlace:5543", "1");
  ...
  void testGetLatestVersionOfVersionedStopPlace() {
    StopPlace stopPlace = index
      .getStopPlaceIndex()
      .getLatestVersion("NSR:StopPlace:5543");
