...
class TestLineExport {
  ...
  void testGetServiceJourneyInterchange() {
    ServiceJourneyInterchange serviceJourneyInterchange = index
      .getServiceJourneyInterchangeIndex()
      .get("GOA:ServiceJourneyInterchange:6");
    Assertions.assertNotNull(serviceJourneyInterchange);
  }

  @Test
  void testGetDatedServiceJourneysByServiceJourneyRef() {
    Collection<DatedServiceJourney> datedServiceJourneys = index
      .getDatedServiceJourneyByServiceJourneyRefIndex()
      .get("GOA:ServiceJourney:B701-B5_200");
